...
if(NOT ( DEFINED "USE_SYSTEM_${extProjName}" AND "${USE_SYSTEM_${extProjName}}" ) )
  ...
  if(UNIX)
    set(Boost_url "http://sourceforge.net/projects/boost/files/boost/1.87.0/boost_1_87_0.tar.gz")
    set(Boost_md5 f435e8ae57edb203a1165cdb99cfb2a3)
    set(Boost_Bootstrap_Command ./bootstrap.sh)
    set(Boost_b2_Command ./b2)
  else()
    if(WIN32)
      set(Boost_url "http://sourceforge.net/projects/boost/files/boost/1.87.0/boost_1_87_0.zip")
  ...
  if(MSVC)
    ...
    elseif(MSVC_VERSION GREATER_EQUAL 1920 AND MSVC_VERSION LESS 1944)
